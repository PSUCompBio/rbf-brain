...
parser.add_argument('--m', default=None, type=str, help="Path to your Fiber-Mesh VTK File");
parser.add_argument('--output', default=None, type=str, help="Path to save your Morphed VTK File (e.g. fiber_morphed_mesh.vtk)");
...
#write to text file
fcg = open(output_morphed_vtk_path, 'w')
fcg.write("%f %f %f" %(new_mesh_points[0][0], new_mesh_points[0][1], new_mesh_points[0][2]))
fcg.close()
